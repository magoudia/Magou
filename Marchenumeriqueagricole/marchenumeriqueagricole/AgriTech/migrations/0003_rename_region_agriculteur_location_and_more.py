...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='agriculteur',
            name='bio',
            field=models.TextField(default='À compléter'),
        ),
        migrations.AlterField(
            model_name='produit',
            name='agriculteur',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='AgriTech.agriculteur'),
        ),
        migrations.AlterField(
            model_name='produit',
            name='image',
